...
Item::Item(string inputName, int inputSigil, string inputColor, int xPos, int yPos, bool obstructFlag, bool visibleFlag) :
Actor(inputName, inputSigil, inputColor, xPos, yPos, obstructFlag, visibleFlag)
{	}
Item::Item(string inputName, int inputSigil, string inputColor, cpair inputLocation, bool obstructFlag, bool visibleFlag) :
Actor(inputName, inputSigil, inputColor, inputLocation, obstructFlag, visibleFlag)
{	}

// **** SPECIFIC ITEMS
Wrench::Wrench(int xPos, int yPos) :
Item("wrench", 0x00A5, "grey", xPos, yPos, false, true)
